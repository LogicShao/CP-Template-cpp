...
* [基础算法](./1_基础算法.md#基础算法)
    * [排序算法](./1_基础算法.md#排序算法)
        * [1 快速排序](./1_基础算法.md#1 快速排序)
        * [2 归并排序](./1_基础算法.md#2 归并排序)
    * [二分](./1_基础算法.md#二分)
        * [整数二分算法模板](./1_基础算法.md#整数二分算法模板)
        * [1 区间[l, r]被划分成[l, mid]和[mid + 1, r]时使用](./1_基础算法.md#1 区间[l, r]被划分成[l, mid]和[mid + 1, r]时使用)
        * [2 区间[l, r]被划分成[l, mid - 1]和[mid, r]时使用](./1_基础算法.md#2 区间[l, r]被划分成[l, mid - 1]和[mid, r]时使用)
        * [3 浮点数二分算法模板](./1_基础算法.md#3 浮点数二分算法模板)
    * [高精度](./1_基础算法.md#高精度)
        * [1 加法](./1_基础算法.md#1 加法)
        * [2 减法](./1_基础算法.md#2 减法)
        * [3 乘法](./1_基础算法.md#3 乘法)
...
* [数据结构](./2_数据结构.md#数据结构)
    * [链表](./2_数据结构.md#链表)
        * [1 单链表](./2_数据结构.md#1 单链表)
        * [2 双链表](./2_数据结构.md#2 双链表)
    * [栈](./2_数据结构.md#栈)
    * [队列](./2_数据结构.md#队列)
    * [单调队列](./2_数据结构.md#单调队列)
    * [单调栈](./2_数据结构.md#单调栈)
    * [KMP](./2_数据结构.md#KMP)
    * [Trie 树](./2_数据结构.md#Trie 树)
    * [并查集](./2_数据结构.md#并查集)
    * [堆](./2_数据结构.md#堆)
...
* [网络流初步](./6_网络流初步.md#网络流初步)
    ...
    * [dinic 求最大流](./6_网络流初步.md#dinic 求最大流)
    * [点分裂](./6_网络流初步.md#点分裂)
